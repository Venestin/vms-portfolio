  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-4xl order-2 lg:order-1">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-display tracking-tight mb-8 leading-[1.1] animate-in delay-200">
              Transforming <br />
              <span className="text-gradient">Ideas into Functional</span>{" "}
              <br />
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl leading-relaxed animate-in delay-300">
              Junior Full-Stack Developer with a strong foundation in software
              engineering, experienced in building practical web applications
              using modern front-end and back-end technologies, and bringing
              excellent communication, teaching, and problem-solving skills to
              real-world projects.
            </p>
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 animate-in delay-400">
              <Button
                size="lg"
                className="rounded-full px-6 sm:px-8 py-6 sm:py-7 text-base sm:text-lg group"
              >
                View My Work
              ...
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-6 sm:px-8 py-6 sm:py-7 text-base sm:text-lg glass"
              >
                Get In Touch
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-16 sm:mt-20 animate-in delay-500">
              <div className="glass-card p-5 sm:p-6 rounded-2xl group hover:border-primary/50 transition-all duration-500">
                ...
                <h3 className="text-lg sm:text-xl font-bold font-display mb-2 sm:mb-3">
                  Full-Stack Dev
                </h3>
                <p className="text-muted-foreground text-xs sm:text-sm">
                  HTML, CSS, JS, Node.js, C#, Bootstrap. Building robust backend
              ...
              <div className="glass-card p-5 sm:p-6 rounded-2xl group hover:border-primary/50 transition-all duration-500">
                ...
                <p className="text-muted-foreground text-xs sm:text-sm">
                  Figma expert. Creating pixel-perfect designs that are
              ...
              <div className="glass-card p-5 sm:p-6 rounded-2xl group hover:border-primary/50 transition-all duration-500 sm:col-span-2 lg:col-span-1">
                ...
                <p className="text-muted-foreground text-xs sm:text-sm">
                  Driving conversion and growth with data-driven marketing
                  strategies.
                </p>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden border-3 sm:border-4 border-primary/20 shadow-2xl glass">
                  <div className="relative w-full h-full">
                    <img
                      src={`${import.meta.env.BASE_URL}Profile-photo.webp`}
                      alt="Developer Portfolio"
                      className="w-full h-full object-cover object-[50%_-15%] hover:scale-110 transition-transform duration-700"
                    />
      ...
      <style>{`
        ...
        .animate-ping-slower { animation: ping-slower 7s ease-in-out infinite; animation-delay: 1s; }
      `}</style>
    </section>
  );
}
